...
if(!empty($consignatarios)){
    ...
    for ($i=0; $i < sizeof($consignatarios) ; $i++) { 
        ...
        $cantidadCompras = ControladorDatosCompras::ctrContarDatosRango($item,$consignatario,null,null,'=','fecha',$fechaInicial,$fechaFinal);

        $dataAnimalesConsignatario[$i]['cantidadCompras'] = $cantidadCompras['total'];
    }
    ...
    ********/
    ...
    $precioPromedioTotalPorConsignatario = number_format(($dataAnimalesConsignatario[0]['precio'] / $dataAnimalesConsignatario[0]['cantidadCompras']), 2,'.','');
    ...
    for ($i=1; $i < sizeof($dataAnimalesConsignatario) ; $i++) { 
        ...
        $precioPromedioTotalPorConsignatario = $precioPromedioTotalPorConsignatario.','.number_format($dataAnimalesConsignatario[$i]['precio'] / $dataAnimalesConsignatario[$i]['cantidadCompras'], 2,'.','');
